 ...
 *
 * Prevents Twenty Fourteen from running on WordPress versions prior to 4.0,
 ...
 * Twenty Fourteen on WordPress versions prior to 4.0.
 *
 * @since Twenty Fourteen 1.0
 */
function twentyfourteen_upgrade_notice() {
	$message = sprintf( __( 'Twenty Fourteen requires at least WordPress version 4.0. You are running version %s. Please upgrade and try again.', 'twentyfourteen' ), $GLOBALS['wp_version'] );
...
function twentyfourteen_customize() {
	wp_die( sprintf( __( 'Twenty Fourteen requires at least WordPress version 4.0. You are running version %s. Please upgrade and try again.', 'twentyfourteen' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function twentyfourteen_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( __( 'Twenty Fourteen requires at least WordPress version 4.0. You are running version %s. Please upgrade and try again.', 'twentyfourteen' ), $GLOBALS['wp_version'] ) );
	}
}
